...
fun LoginScreen(
    ...
    Column(
        ...
        TextField(modifier = Modifier.fillMaxWidth(), value = email, label = "Email", onTextChange = authViewModel::onUsernameChange)
        Spacer(modifier = Modifier.height(8.dp))
        TextField(modifier = Modifier.fillMaxWidth(), value = password, label = "Password", visualTransformation = PasswordVisualTransformation(), onTextChange = authViewModel::onPasswordChange)
